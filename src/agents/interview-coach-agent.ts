...
export class InterviewCoachAgent extends BaseAgent {
  ...
  protected getSystemPrompt(): string {
    return `Generate personalized cover letters and prepare candidates for interviews.

For cover letters:
- Keep it concise (3-4 paragraphs, under 400 words)
- Start with a strong opening showing genuine interest
...
- Help craft compelling "story" responses using STAR method (Situation, Task, Action, Result)
...
- Prepare compelling "why this company" and "why this role" answers
- Develop thoughtful questions about the team and role

Be authentic and strategic. Help candidates present their best self while remaining genuine.`
  }

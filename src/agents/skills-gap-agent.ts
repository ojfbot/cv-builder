...
export class SkillsGapAgent extends BaseAgent {
  ...
  protected getSystemPrompt(): string {
    return `Compare candidate skills against job requirements, identify gaps, and create personalized learning paths.
...
- Consider the candidate's background and learning context
...
Be supportive and practical. Focus on actionable learning strategies.`
  }
